...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org clang-format elpy flycheck htmlize org simple-rtm esup org-bullets
         which-key org-preview-html company-irony company-irony-c-headers
         flycheck-irony company-quickhelp flycheck-pos-tip json-mode ghc
         haskell-mode company-ghc flycheck-haskell flycheck-hdevtools
         flycheck-ghcmod hindent irony-eldoc magit)))
